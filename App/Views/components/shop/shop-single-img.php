<?php
function __shop_single_img($product){
    ?>
<div class="images electro-gallery">
	<div class="thumbnails-single owl-carousel">
		<a href="<?= $product->product_image ?>" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
			<img style="max-height:300px;object-fit:contain" src="/Public/assets/images/blank.gif" data-echo="<?= $product->product_image ?>" class="wp-post-image" alt="">
		</a>

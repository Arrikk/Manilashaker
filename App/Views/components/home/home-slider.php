...
<style>
    ...
    <div class="home-v2-slider">
        ...
        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
            ...
            <div class="item" style="background-image: url(/Public/assets/images/bg/03.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-md-offset-1 col-md-5">
                            <div class="caption vertical-center text-left ">
                                ...
                                <div class="hero-action-btn fadeInDown-4">
                                    <a href="/gadgets/gadgets" class="big le-button ">Start Buying</a>
                                </div>
                            </div><!-- /.caption -->
                        </div>
                    </div>
            ...
            <div class="item" style="background-image: url(/Public/assets/images/bg/04.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-md-offset-1 col-md-5">
                            <div class="caption vertical-center text-left">

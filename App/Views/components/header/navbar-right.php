                            ...
                            <ul class="cart_list product_list_widget ">
                                ...
                                <li class="mini_cart_item">
                                    ...
                                    <a href="index.php?page=single-product">
                                        <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="/Public/assets/images/products/mini-cart1.jpg" alt="">White lumia 9001&nbsp;							
                                    </a>
                                ...
                                <li class="mini_cart_item">
                                    <a title="Remove this item" class="remove" href="#">×</a>													
                                    <a href="index.php?page=single-product">
                                        <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="/Public/assets/images/products/mini-cart2.jpg" alt="">PlayStation 4&nbsp;	
                                    </a>
                                ...
                                <li class="mini_cart_item">
                                    ...
                                    <a href="index.php?page=single-product">
                                    <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="/Public/assets/images/products/mini-cart3.jpg" alt="">POV Action Cam HDR-AS100V&nbsp;		
